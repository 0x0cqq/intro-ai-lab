# copy from https://github.com/colyk/maze-generator/blob/master/maze_generator.py
import sys
import random
from tkinter import *
...
class Maze(object):
    ...
    def text_maze(self):
        ...
        try:
            self.maze[1][0] = '%'
            self.maze[1][1] = 'P'
            self.maze[self.height-2][self.height-2] = '.'
